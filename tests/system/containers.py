...
class StorkServerContainer(Container):
    ...
    def prepare_system(self):
        ...
        if self.pkg_format == 'deb':
            ...
            self.run('yum --nogpgcheck localinstall https://download.postgresql.org/pub/repos/yum/11/redhat/rhel-7-x86_64/postgresql11-libs-11.13-1PGDG.rhel7.x86_64.rpm https://download.postgresql.org/pub/repos/yum/11/redhat/rhel-7-x86_64/postgresql11-11.13-1PGDG.rhel7.x86_64.rpm')
