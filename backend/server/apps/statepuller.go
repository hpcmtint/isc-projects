...
// the Kea apps.
func NewAppsStatePuller(db *dbops.PgDB, agents agentcomm.ConnectedAgents, eventCenter eventcenter.EventCenter) (*AppsStatePuller, error) {
	puller := &AppsStatePuller{
...
func (puller *AppsStatePuller) Shutdown() {
...
// have the HA enabled.
func (puller *AppsStatePuller) pullData() (int, error) {
...
func (puller *AppsStatePuller) getAppState(dbApp *dbmodel.App) error {
