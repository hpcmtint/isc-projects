...
describe('DhcpOptionSetForm', () => {
    ...
    it('serializes an option set', () => {
        ...
        expect(serialized[0].hasOwnProperty('encapsulates')).toBeTrue()
        ...
        expect(serialized[0].encapsulates.length).toBe(0)
        ...
        expect(serialized[1].hasOwnProperty('encapsulates')).toBeTrue()
        ...
        expect(serialized[1].encapsulates.length).toBe(0)
        ...
        expect(serialized[2].hasOwnProperty('encapsulates')).toBeTrue()
        ...
        expect(serialized[2].encapsulates).toBe('option-3087')
        ...
        expect(serialized[2].options[0].hasOwnProperty('encapsulates')).toBeTrue()
        ...
        expect(serialized[2].options[0].encapsulates.length).toBe(0)
